...
本项目采用 MIT 许可证 - 详见 [LICENSE](https://github.com/zwldarren/akshare-two/blob/main/LICENSE) 文件。

## 🔗 相关链接

- [GitHub 仓库](https://github.com/zwldarren/akshare-two)
- [PyPI 包](https://pypi.org/project/akshare-two/)
- [AKShare 原项目](https://github.com/akfamily/akshare)
- [AKShare One MCP](https://github.com/zwldarren/akshare-two-mcp)
